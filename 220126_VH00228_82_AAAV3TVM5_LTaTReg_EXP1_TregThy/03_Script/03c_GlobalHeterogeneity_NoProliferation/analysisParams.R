...
ANALYSIS_STEP_NAME = "03c_GlobalHeterogeneity_NoProliferation"
PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Analysis of Not proliferating Cells"
...
# RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "0"]] = 2
# RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "1"]] = 4
# RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "2"]] = 1
# RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "3"]] = 3
# RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "4"]] = 0
...
CLUSTER_GROUP_LIST = list( ClusterGroup_NotProliferating = c( 2, 3, 4, 5, 6, 7, 8, 9))
