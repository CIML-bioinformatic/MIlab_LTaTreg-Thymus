...
ANALYSIS_STEP_NAME = "03f_GlobalHeterogeneity_NoProliferation_NoContamination_NoCirculating"
PATH_ANALYSIS_OUTPUT = file.path( PATH_EXPERIMENT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Analysis of Not proliferating Cells with removal of contamining CD4SP cells and circulating cells."
...
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "2"]] = 0
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "3"]] = 1
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "4"]] = 2
...
CLUSTER_GROUP_LIST = list( ClusterGroup_NotProliferating_NoContamination_NoCirculating = c( 2, 4, 6, 7, 8))
