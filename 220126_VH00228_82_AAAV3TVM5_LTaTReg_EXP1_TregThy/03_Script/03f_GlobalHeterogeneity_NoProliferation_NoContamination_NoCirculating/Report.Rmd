...
useReduction='umap'
<<heterogeneity_dimReduc_UMAPPlot>>
rm("useReduction");
```
...
```{r rmd_heterogeneity_markerGenes_functional_enrichment, fig.dim = c(8, 8) }
cat("\n<a href='#clusters-projection'>");
useReduction='umap'; #c( 'umap', 'tsne');
<<heterogeneity_dimReduc_thumbnail>>
rm("useReduction");
...
```{r rmd_heterogeneity_markerGenes_heatmap_mean, fig.dim = c(8, 8)}
...
<!--##### Heatmap of mean expression in clusters of chosen markers 
```{r rmd_heterogeneity_chosenMarkerGenes_heatmap_mean}

<<heterogeneity_chosenMarkerGenes_heatmap_mean>>
...
#### UMAP density plot {.tabset .tabset-fade}
...
```{r rmd_heterogeneity_chosenGroupGenes_heatmap_mean, fig.dim = c(9, 9)}
