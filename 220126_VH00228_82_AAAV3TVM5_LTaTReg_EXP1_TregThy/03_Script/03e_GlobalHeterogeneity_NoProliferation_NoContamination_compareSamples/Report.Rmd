...
read_chunk( path=file.path( WORKING_DIR, "02_compareClusterExpression.R"));
read_chunk( path=file.path( WORKING_DIR, "03_examineClusterExpression.R"));
read_chunk( path=file.path( WORKING_DIR, "04_functionalEnrichment_KEGG.R"));
read_chunk( path=file.path( WORKING_DIR, "05_pathwayAnalysis_KEGG.R"));
...
## Compare gene expression in cluster between WT and KO samples (Wicoxon method)
...
<!--
## Compare gene expression in cluster between WT and KO samples (DESseq2 method)
