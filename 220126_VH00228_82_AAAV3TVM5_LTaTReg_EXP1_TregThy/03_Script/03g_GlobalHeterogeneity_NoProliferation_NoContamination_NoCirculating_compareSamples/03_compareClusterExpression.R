...
cat("### DEG analysis for each cluster {.tabset .tabset-fade}")
...
for( clusterid in levels( Idents( sc10x.seurat))){
  ...
  volcano_df = current_sample_cluster_markergenes_df
  volcano_df$gene = row.names( volcano_df)
  
  print(
  EnhancedVolcano::EnhancedVolcano( volcano_df, 
                                    y = "p_val_adj", 
                                    x = "avg_log2FC", 
                                    lab = row.names( volcano_df),
                                    pCutoff = 0.05,
                                    FCcutoff = 0.5,
                                    legendPosition = NULL,
                                    legendLabSize = 16,
                                    ...
                                    title = paste( "DEG between KO and WT for cluster", clusterid),
                                    subtitle = "")
  )
...
# ...................................................................
cat("\n  \n")
cat("### Enrichment of marker genes of clusters in chosen groups on genes")
cat("\n  \n")
...
# ................................................................
cat("\n  \n")
cat("### Difference of expression of DEG between WT and KO clusters")
cat("\n  \n")
...
if( exists( "CHOSEN_MARKER_GENES")){
  ...
  cat("\n  \n")
  cat("### Difference of expression of Chosen marker genes between WT and KO clusters")
  cat("\n  \n")
