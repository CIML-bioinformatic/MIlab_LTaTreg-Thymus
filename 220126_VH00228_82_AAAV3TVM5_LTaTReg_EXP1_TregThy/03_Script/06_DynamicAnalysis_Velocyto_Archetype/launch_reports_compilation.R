...
rmarkdown::render( input = file.path( WORKING_DIR, "Report.Rmd"),
                   ...
                   output_file  = paste0( SCIENTIFIC_PROJECT_NAME, "_", EXPERIMENT_NAME, "_", ANALYSIS_STEP_NAME, "_K", AUTOENCODER_LAYER_INTERNAL_NODES, "_N", AUTOENCODER_LAYER_IN_OUT_NODES, ".html"),
                   quiet = FALSE)  
