...
```{r rmd_heterogeneity_markerGenes_functional_enrichment}
cat("\n<a href='#clusters-projection'>");
useReduction='umap'; #c( 'umap', 'tsne');
<<heterogeneity_dimReduc_thumbnail>>
rm("useReduction");
...
```{r rmd_heterogeneity_markerGenes_heatmap_mean}
...
##### Heatmap of mean expression in clusters of groups of genes
