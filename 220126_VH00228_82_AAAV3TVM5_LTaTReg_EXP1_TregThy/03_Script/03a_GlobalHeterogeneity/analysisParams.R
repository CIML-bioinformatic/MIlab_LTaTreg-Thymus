...
ANALYSIS_STEP_NAME = "03a_GlobalHeterogeneity"
...
PATH_10XFILES = c( "RUN1_THY1" = file.path( PATH_EXPERIMENT_OUTPUT,
...
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "0"]] = 8
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "1"]] = 7
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "2"]] = 4
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "3"]] = 2
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "4"]] = 5
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "5"]] = 3
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "6"]] = 9
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "7"]] = 6
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "8"]] = 0
RENAME_CLUSTERS[[ SAMPLE_ALL]][[ "9"]] = 1
...
CLUSTER_GROUP_LIST = list( ClusterGroup_7_8_9 = c( 7, 8, 9))
