...
read_chunk( file.path( WORKING_DIR, "02_estimateTrajectory.R"));

# Import chunks from source files
```

---
title: `r paste( SCIENTIFIC_PROJECT_NAME, ANALYSIS_STEP_LITTERAL_DESCRIPTION, SAMPLE_NAME, sep =" <BR> ")`
---
...
## Load data from previous global heterogeneity analysis
```{r prepareData}
<<prepare_data>>
```

## Estimate trajectory of cells using Monocle 3  {.tabset .tabset-fade}
```{r estimateTrajectory, warning=FALSE, message=FALSE, echo=FALSE}
<<estimate_trajectory>>
```
